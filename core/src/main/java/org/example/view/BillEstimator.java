...
public class BillEstimator extends JFrame {
    ...
    private void initRegularUnitsPanel() {
        ...
        spinRegularUnits.addChangeListener(e -> updateTotal());
    ...
    private void initPeakUnitsPanel() {
        ...
        spinPeakUnits.addChangeListener(e -> updateTotal());
        add(peakUnitsPanel);
    }
    ...
    private void updateTotal() {
        ...
        Double salesTaxAmount = costOfElectricity * (myTariffTax.getTaxPercentage() / 100);
